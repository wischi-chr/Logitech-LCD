...
namespace LgLcd
{
    ...
    public class Device
    {
        ...
        public void Open(Applet applet, DeviceType type)
        {
            ...
            if (!applet.Connected) throw new Exception("Applet must be connected to LCDMon.");
            if (type != DeviceType.Monochrome && type != DeviceType.Qvga) throw new InvalidEnumArgumentException();
        ...
        private int OnSoftButtons(int device, LgLcd.SoftButtonFlags buttons, IntPtr context)
        {
            ...
            switch (buttons)
            {
                case LgLcd.SoftButtonFlags.Left: e = Left; break;
                case LgLcd.SoftButtonFlags.Right: e = Right; break;
                case LgLcd.SoftButtonFlags.Ok: e = Ok; break;
                case LgLcd.SoftButtonFlags.Cancel: e = Cancel; break;
                case LgLcd.SoftButtonFlags.Up: e = Up; break;
                case LgLcd.SoftButtonFlags.Down: e = Down; break;
                case LgLcd.SoftButtonFlags.Menu: e = Menu; break;
            }
